      ...
      <section className="mx-auto w-4/5 bg-[#D0D0D0]/[.07] rounded-3xl flex flex-col">
        <div className="w-full h-full pt-10 px-14 flex flex-col gap-20">
          <section className="flex gap-14 h-[666px]">
            ...
            >
              <Ex1 />
              <button className="w-[33px] h-[33px] absolute top-3 right-6">
                <Edit />
              </button>
            </div>
            ...
            <div className="flex-1 border-2 flex flex-col justify-between">
              <div className="flex flex-col gap-3">
                ...
                <h2 className="text-5xl relative">
                  ...
                  <button className="absolute right-0 bottom-[50%]">
                    <Edit />
                  </button>
                </h2>
              </div>
          ...
          <section>
            <div className="flex text-2xl gap-10">
              ...
              <div className="w-[704px] rounded-[30px] bg-[#777]/[0.2] placeholder:text-white placeholder:text-2xl flex items-center px-5 gap-3">
                ...
                <span className="text-white text-2xl">Search:</span>
                <input
                  type="text"
                  className="bg-transparent outline-none text-white"
                />
              </div>
              <button className="right-20 text-white ml-12">Recent ▼</button>
            </div>

  ...
  return (
    ...
    >
      <h3
        ...
        className="my-3 text-lg font-extralight"
      >
        {title}
      </h3>
      <ul>
        {items.map(({ subtitle, content, type, options }, index) => (
          <li className="flex items-center gap-6 py-1 text-lg" key={index}>
            ...
            {type === "select" && options ? (
              <div className="relative inline-block">
                ...
                >
                  <span className="bg-fifth/[.2] rounded-3xl px-10 py-3 cursor-pointer min-w-[280px] relative">

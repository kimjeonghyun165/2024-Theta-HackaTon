  ...
  return (
    <section className="flex gap-5 px-5 py-5 border-2 bg-third rounded-[44px]">
      ...
      <div className="flex flex-col flex-1 gap-10">
        <span className="text-4xl text-center 2xl:text-5xl">
          ELK MAN WITH FOUR HORNS
        </span>
        ...
        <p>
          DESCRIPTION this is an example of a description. Users can provide
          details about their artwork, such as the intention behind it, the
          appeal of their 3D assets, and relevant keywords.{" "}
        </p>
        <p>
          #Animal #Personify #Monster #Horn #Elk #Man #MacallanCraigellachie
        </p>
